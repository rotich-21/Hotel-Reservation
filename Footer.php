...
<footer style="background-color: #393939;">
    ...
    <p style="color: #fff;" class="text-justify">A GUEST HOUSE is an establishment that provides paid lodging on a short-term basis. Facilities provided may range from a modest-quality mattress in a small room to large suites with bigger, higher-quality beds, a dresser, a refrigerator and other kitchen facilities, upholstered chairs, a flat screen television, and en-suite bathrooms. Small, lower-priced GUEST HOUSE may offer only the most basic guest services and facilities. Larger, higher-priced GUEST HOUSE may provide additional guest facilities such as a swimming pool, business center</p><br>
...
?>
	...
	<div class="col-sm-4 text-justify">
      ...
      <p style="color:white;"><strong>Address:&nbsp;</strong>399-00100, Nairobi kenya</p>
      <p style="color:white;"><strong>Email-Id:&nbsp;</strong>guest@gmail.com</p>
      <p style="color:white;"><strong>Contact Us:&nbsp;</strong>+25472700000000</p><br><br><br>
...
<footer class="container-fluid text-center"style="background-color:#000408;height:40px;padding-top:10px;color:#f0f0f0;">
  <p>All Rights Reserved 2021<sup>TM</sup></p>
</footer>
